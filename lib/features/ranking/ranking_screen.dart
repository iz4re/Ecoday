    ...
    return Column(
      ...
      children: [
        ...
        ListView.separated(
          ...
          itemCount: dummyRankings.length,
          separatorBuilder: (context, index) => const SizedBox(height: 8),
          itemBuilder: (context, index) {
            final user = dummyRankings[index];
            return LeaderboardItem(
              ...
              level: user['level'],
              xp: user['xp'],
              hasSpecialBadges: user['hasSpecialBadges'] ?? false,
              badgeIcons: user['badgeIcons'] != null ? List<IconData>.from(user['badgeIcons']) : [],
